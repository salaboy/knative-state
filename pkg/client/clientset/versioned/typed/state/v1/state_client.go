...
import (
	...
	"github.com/salaboy/knative-state/pkg/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*FlowV1Client, error) {
	...
	return &FlowV1Client{client}, nil
}

// NewForConfigOrDie creates a new FlowV1Client for the given config and
