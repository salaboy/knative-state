...
import (
	...
	statemachine "github.com/salaboy/knative-state/pkg/client/injection/informers/state/v1/statemachine"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "statemachine-controller"
	defaultFinalizerName       = "statemachines.flow.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	statemachineInformer := statemachine.Get(ctx)

	lister := statemachineInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.knative.dev.StateMachine"),
	)
