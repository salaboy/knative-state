...
import (
	...
	versionedscheme "github.com/salaboy/knative-state/pkg/client/clientset/versioned/scheme"
	client "github.com/salaboy/knative-state/pkg/client/injection/client"
	statemachinerunner "github.com/salaboy/knative-state/pkg/client/injection/informers/state/v1/statemachinerunner"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "statemachinerunner-controller"
	defaultFinalizerName       = "statemachinerunners.flow.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	statemachinerunnerInformer := statemachinerunner.Get(ctx)

	lister := statemachinerunnerInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.knative.dev.StateMachineRunner"),
	)
